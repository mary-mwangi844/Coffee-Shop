...
export default function Equipment() {
  return (
    <>
      <section id="equipment" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=1920&h=1080&fit=crop)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', minHeight: '100vh', paddingTop: '100px' }}>
        <h2 className="section-title">Equipment</h2>
        <p className="section-subtitle">Professional tools we use to craft perfection</p>
